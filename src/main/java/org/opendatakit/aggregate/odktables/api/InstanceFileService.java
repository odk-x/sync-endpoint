...
public interface InstanceFileService {
  ...
  @GET
  @Path("file/{filePath:.*}")
  public Response getFile(@Context HttpHeaders httpHeaders, @PathParam("filePath") List<PathSegment> segments, @QueryParam(PARAM_AS_ATTACHMENT) String asAttachment, @QueryParam("reduceColor") String reduceColor, @QueryParam("reduceSize") String reduceSize) throws IOException, ODKTaskLockException, PermissionDeniedException;
